(function($, window) {
    ...
    var tpl_category_tr = [
        ...
        '</td>',
        '<td class="operator"><input type="checkbox" class="status" data-status="{{this.isActive}}" data-text="分类" name="isActive"></td>',
        '<td class="operator">',
    ...
    var tpl_select = ['<select class="form-control" name="{{name}}">',
        '{{#if defaultOption}}',
        '<option value="{{defaultOption.value}}" {{defaultOption.selected}}>{{defaultOption.name}}</option>',
        '{{/if}}',
        '{{#each options}}',
        ...
        '<div class="tab-content">',
                ...
                '<div class="clearfix">',
                    '<form class="form-horizontal form-food col-md-6">',
                        ...
                        '<div class="form-group">',
                            ...
                            '</div>',
                        '</div>',
                        '<div class="form-group food-type">',
                            '<label class=" col-sm-2 control-label">菜品类型</label>',
                            '<div class="col-sm-9">',
                                '<label class="control-label m-r">',
                                    '<input type="radio" name="foodType" value="0" {{typeDisabled}}> 普通菜',
                                '</label>',
                                '<label class="control-label m-r">',
                                    '<input type="radio" name="foodType" value="1" {{typeDisabled}}> 套餐',
                                '</label>',
                                '<label class="control-label m-r">',
                                    '<input type="radio" name="foodType" value="2" {{typeDisabled}}> 临时菜',
                                '</label>',
                                '<div class="temp-food m-t hidden">',
                                    '<span class="text-warning">云餐饮管理系统中可修改菜品名称和价格</span>',
                                '</div>',
                            '</div>',
                        '</div>',
                        '<div class="form-group">',
                            ...
                            '<div class="col-sm-6">',
                                '<label class="control-label">',
                                    '<input type="checkbox" name="incrementUnit" {{checkedIncrementUnit}} /> 允许菜品数量输入小数点后一位',
                                '</label>',
                            '</div>',
                        '</div>',
                    '</form>',
            ...
            '<div class="tab-pane fade" id="goodDetailInfo">',
                '<form class="form-horizontal form-food-detail">',
                    '<div class="form-group">',
                        '<label class="col-sm-2 control-label">第二出品部门&nbsp;</label>',
                        '<div class="col-md-3" name="departmentsSelect2">',
                        '</div>',
                    '</div>',
                    '<div class="form-group">',
    ...
    var tpl_good_unit_tr = [
        ...
        '<td><input type="text" name="foodEstimateCost" value="{{foodEstimateCost}}"/></td>',
        '<td>',
    ...
    var tpl_set_food_tr= [
        '<tr class="food" data-unitkey="{{unitKey}}" data-foodkey="{{foodKey}}" data-estimatecost="{{foodEstimateCost}}">',
        ...
        '<form class="feed-back-out read-mode">',
            '<div class="clearfix">',
                ...
                '<div class="col-lg-4 form-horizontal">',
                    '<div class="form-group">',
                        '<label class="col-sm-5 control-label">账单抹零方式</label>',
                        '<div class="col-md-6">',
                    ...
                    '<div class="form-group">',
                        '<label class="col-sm-5 control-label">结账清单打印份数</label>',
                        '<div class="col-md-6">',
                    ...
                    '<div class="form-group">',
                        '<label class="col-sm-5 control-label">明细打印方式</label>',
                        '<div class="col-md-6">',
                    ...
                    '<div class="form-group">',
                        '<label class="col-sm-5 control-label">明细金额类型</label>',
                        '<div class="col-md-6">',
                    ...
                    '<div class="form-group">',
                        '<label class="col-sm-5 control-label">服务器连接的打印机</label>',
                        '<div class="col-md-6">',
                ...
                '<div class="col-lg-4 form-horizontal">',
                    '<div class="form-group">',
                        '<label class="col-sm-5 control-label">结账单顶部补打内容</label>',
                        '<div class="col-md-7">',
                    ...
                    '</div>',
                    '<div class="form-group">',
                        '<label class="col-sm-5 control-label">结账单底部补打内容</label>',
                        '<div class="col-md-7">',
                    ...
                    '</div>',
                    '<div class="form-group">',
                        '<label class="col-sm-5 control-label">是否打印会员交易顾客联凭证</label>',
                        '<div class="col-md-7">',
                ...
                '<div class="form-horizontal col-md-3">',
                    '<div class="form-group file-upload shop-params-logo">',
                        '<label class="controle-label col-sm-4">账单logo</label>',
                        '<div class="col-md-6">',
                            '<div class="clearfix">',
                                '<img alt="账单logo" src="{{CheckoutBillPrnLogoPath}}" width="120px"/>',
                                '<span>上传中……</span>',
                            '</div>',
                            '<div class="m-t warning text-warning">单色位图且不超过8K</div>',
                            '<label class="btn-link" for="myFile">编辑账单LOGO</label>',
                        '</div>',
                    '</div>',
                '</div>',
            '</div>',
            '<div class="clearfix form-horizontal">',
                '<h4 class="page-header">厨房打印</h4>',
                '<div class="col-lg-3 form-horizontal">',
                    '<div class="form-group">',
                        '<label class="col-sm-6 control-label">是否启用厨房打印</label>',
                        '<div class="col-md-6">',
                ...
                '<div class="col-lg-9 form-horizontal">',
                    '<div class="form-group">',
                        ...
                        '<div class="col-md-4">',
                            ...
                            '</div>',
                        '</div>',
                        '<label class="col-sm-3 control-label">厨房小票桌台号使用字体</label>',
                        '<div class="col-md-3">',
                            '<p class="form-control-static">{{KitchenTableNameBigFontVal}}</p>',
                            '{{> customSelect KitchenTableNameBigFontData}}',
                        '</div>',
                    '</div>',
                '</div>',
            '</div>',
            '<div class="clearfix form-horizontal">',
                '<h4 class="page-header">出品</h4>',
                '<div class="col-lg-3 form-horizontal">',
                    '<div class="form-group">',
                        '<label class="col-sm-6 control-label">是否启用出品管理</label>',
                        '<div class="col-md-6">',
                            '<input type="checkbox" name="IsFoodMakeStatusActive" class="status" data-status="{{IsFoodMakeStatusActive}}" disabled />',
                        '</div>',
                    '</div>',
                    '<div class="form-group">',
                        '<label class="col-sm-6 control-label">是否通过微信推送菜品制作状态消息</label>',
                        '<div class="col-md-3">',
                            '<input type="checkbox" name="IsPushWeChatMsgByFoodMakeStatusChange" class="status" data-status="{{IsPushWeChatMsgByFoodMakeStatusChange}}" data-label="push" disabled />',
                        '</div>',
                    '</div>',
                '</div>',
                '<div class="col-lg-9 form-horizontal">',
                    '<div class="form-group make-status">',
                        '<label class="col-sm-2 control-label">进行中账单数</label>',
                        '<div class="col-md-2">',
                            '<p class="form-control-static">{{FoodMakeManageQueueCount}}单</p>',
                            '<input name="FoodMakeManageQueueCount" class="form-control" value="{{FoodMakeManageQueueCount}}"/>',
                        '</div>',
                        '<label class="col-sm-2 control-label">出品警告超时时间(秒)</label>',
                        '<div class="col-md-2">',
                            '<p class="form-control-static">{{FoodMakeWarningTimeout}}秒</p>',
                            '<input name="FoodMakeWarningTimeout" class="form-control" value="{{FoodMakeWarningTimeout}}"/>',
                        '</div>',
                        '<label class="col-sm-2 control-label">出品严重超时时间(秒)</label>',
                        '<div class="col-md-2">',
                            '<p class="form-control-static">{{FoodMakeDangerTimeout}}秒</p>',
                            '<input name="FoodMakeDangerTimeout" class="form-control" value="{{FoodMakeDangerTimeout}}"/>',
                        '</div>',
                    '</div>',
                    '<div class="form-group">',
                        '<label class="control-label col-sm-3">叫号取餐电视屏幕滚动标题</label>',
                        '<div class="col-md-3">',
                            '<p class="form-control-static">{{FoodCallTakeTVTitle}}</p>',
                            '<input type="text" class="form-control" name="FoodCallTakeTVTitle" maxlength=500 value="{{FoodCallTakeTVTitle}}">',
                        '</div>',
                    '</div>',
                '</div>',
            '</div>',
            ...
            '</div>',
           '<div class="clearfix">',
                '<h4 class="page-header">点菜宝</h4>',
                '<div class="col-lg-3 form-horizontal">',
                    '<div class="form-group">',
                        '<label class="col-sm-6 control-label">启用快速点餐模式</label>',
                        '<div class="col-md-6">',
                            '<input type="checkbox" name="mobileOrderingQuickMode" class="status"  data-status="{{mobileOrderingQuickMode}}" disabled />',
                        '</div>',
                    '</div>',
                '</div>',
                '<div class="col-lg-4 form-horizontal">',
                    '<div class="form-group">',
                        '<label class="col-sm-6 control-label">快速点菜模式相同菜品合并</label>',
                        '<div class="col-md-6">',
                            '<input type="checkbox" name="mobileOrderingQuickModeAutoSum" class="status" data-label="merge" data-status="{{mobileOrderingQuickModeAutoSum}}" disabled />',
                        '</div>',
                    '</div>',
                '</div>',
            '</div>',
            '<div class="clearfix form-horizontal">',
                ...
                //'</div>',
                '<div class="form-group">',
                    '<label class="control-label col-sm-2">副屏广告轮播图</label>',
                    '<div class="col-md-10 shop-params-images clearfix">',
                        '{{#each PCScreenImageLst}}',
                            '<div class="col-md-2 image-list">',
                                '<img src="{{this}}" width="120px"/>',
                                '<button class="glyphicon glyphicon-remove"></button>',
                            '</div>',
                        '{{/each}}',
                        '<div class="col-md-2 add-sub-res {{hidden}}">',
                            '<i class="glyphicon glyphicon-plus"></i>',
                            '<label class="btn-link" for="myFile">添加副屏广告轮播图</label>',
                            '<p>上传中……</p>',
                            '<label class="text-warning">图片尺寸建议800*600像素</label>',
                        '</div>',
                    '</div>',
                '</div>',
                '<div class="form-group">',
                    '<label class="col-sm-2 control-label">副屏广告轮播图片播放间隔</label>',
                    '<div class="col-md-2">',
                        '<p class="form-control-static">{{PCScreen2AdImageIntervalTimeVal}}</p>',
                        '{{> customSelect PCScreen2AdImageIntervalTimeData}}',
                    '</div>',
                '</div>',
            '</div>',
