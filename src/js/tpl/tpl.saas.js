(function($, window) {
    ...
    var tpl_set_food_tr= [
        '<tr class="food" data-unitkey="{{unitKey}}" data-foodkey="{{foodKey}}" data-costprice="{{foodEstimatePrice}}">',
        ...
        '<form class="feed-back-out read-mode">',
            '<div class="clearfix">',
                ...
                '<div class="col-lg-8 form-horizontal">',
                    '<div class="form-group">',
                        '<label class="col-sm-3 control-label">结账单顶部补打内容</label>',
                        '<div class="col-md-5">',
                    ...
                    '</div>',
                    '<div class="form-group">',
                        '<label class="col-sm-3 control-label">结账单底部补打内容</label>',
                        '<div class="col-md-5">',
                    ...
                    '</div>',
                    '<div class="form-group">',
                        '<label class="col-sm-3 control-label">是否打印会员交易顾客联凭证</label>',
                        '<div class="col-md-5">',
            ...
            '<div class="clearfix form-horizontal">',
                ...
                '<div class="form-group col-md-6">',
                    '<label class="col-sm-3 control-label">是否启用调试模式</label>',
                    '<div class="col-md-6">',
