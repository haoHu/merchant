(function ($, window) {
			...
			'<form class="row tab-pane feed-back-out" id="tab1">',
				...
				'<div class="col-sm-6 col-md-4 form-horizontal">',
					...
					'<div class="form-group">',
						...
						'<div class="col-xs-3">',
							'<input type="text" id="openingHoursStart" name="openingHoursStart" class="form-control d-ib "  placeholder="08:30" data-default-time="08:30" />',
						'</div>',
						'<div class="col-xs-3">',
	...
	'{{#each foods}}',
		'<tr class="{{first.topBorder}} {{last.BottomBorder}}" data-id="{{foodID}}" data-cid="{{foodCategoryID}}" data-sortindex="{{foodSortIndex}}">',
			...
			'<td>{{#each foodDepartmentNames}}<p>{{this}}</p>{{/each}}</td>',
			'<td>',
			'{{#each units}}',
            ...
            '<div class="form-group rights">',
                ...
                '{{#each rightGroup}}',
                    '<div class="form-group">',
                        ...
                        '<div>',
                            '{{#each this}}',
                                '<label><input type="checkbox" {{checked}} name="right" data-key="{{rightID}}" />&nbsp;{{rightName}}</label>',
                            '{{/each}}',
                        '</div>',
                    '</div>',
                '{{/each}}',
        ...
        '<form class="form-horizontal printer-form">',
        	'<div class="form-group">',
                ...
                '<div class="col-sm-5">',
                	...
                	'<select name="printerBrand"  class="form-control">',
                    	'<option value="">--请选择--</option>',
                        '{{#each printerBrandData}}',
            ...
            '</div>',
            '<div class="form-group">',
            	'<label class="col-sm-offset-1 col-sm-3 control-label">水平方向打印缩进</label>',
            	'<div class="col-sm-5">',
            		'<div class="input-group">',
                    	'<input type="text" name="printOffsetX" class="form-control" value="{{printerData.printOffsetX}}">',
        ...
        '<form class="form-horizontal discount-form">',
            ...
            '<div class="form-group">',
                '<label class="col-sm-offset-1 col-sm-3 control-label">是否享受会员价*</label>',
               	'<div class="col-sm-5">',
	                '<input type="checkbox" class="status isVipPrice" name="isVipPrice" data-status="{{discountData.isVipPrice}}">',
	        	'</div>',             
            '</div>',
            // '<div class="form-group">',
            //     '<label class="col-sm-offset-1 col-sm-3 control-label">是否享受会员价*</label>',
            ...
            '<div class="form-group">',
                '<label class="col-sm-offset-1 col-sm-3 control-label">是否启用*</label>',
               	'<div class="col-sm-5">',
	                '<input type="checkbox" class="status isActive" name="isActive" data-status="{{discountData.isActive}}">',
	        	'</div>',             
            '</div>',
            // '<div class="form-group">',
            //     '<label class="col-sm-offset-1 col-sm-3 control-label">是否启用*</label>',
    ...
    var tpl_edit_shoptime = [
        '<form class="form-horizontal discount-form">',
			...
			'<div class="form-group">',
				...
				'<div class="col-xs-5">',
					'<div class="input-group">',
						'<input type="text" name="endTime" class="form-control" value="{{timeData.endTime}}" readonly>',
				        '<span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>',
				    '</div>',
				'</div>',
			'</div>',
            '<div class="form-group">',
                '<label class="col-sm-offset-1 col-sm-3 control-label">是否启用*</label>',
               	'<div class="col-sm-5">',
	                '<input type="checkbox" class="status" name="isActive" data-status="{{timeData.isActive}}">',
	        	'</div>',             
            '</div>',
        '</form>'].join('');
	...
	'<div class="well well-sm t-r promotion_operate">',
		'{{#if beused}}',
			'<p class="controls">',
				'<span class="controls  t-c beused">该店铺已被其他店铺所套用,不可再套用其它店铺</span>',
			...
			'{{#each items}}',
				...
				'<div class="form-group">',
					...
					'<div class="col-sm-offset-2 col-sm-8 alert alert-warning promotin-stageType">',
						'<label class="">',
							'<input type="radio" origname="{{origname}}" name="{{name}}" {{disabled}} id="{{id}}" value="{{value}}" {{checked}} />',
							'{{label}}',
						'</label>',
				...
				'{{#checkFormElementType type type="textarea"}}',
					'<div class="form-group {{hidden}}">',
						'<label for="{{id}}" class="{{labelClz}}">{{{label}}}</label>',
						'<div class="{{clz}}">',
								'<textarea id="{{id}}" origname="{{origname}}" name="{{name}}" class="form-control" placeholder="{{placeholder}}" value="{{value}}" data-type="{{type}}" {{mode}}>{{{value}}}</textarea>',
						'</div>',
					'</div>',
				'{{/checkFormElementType}}',
				'{{#checkFormElementType type type="text"}}',
							...
							'{{#isInputGroup prefix surfix}}',
								'<div class="input-group">',
									'{{#if prefix}}',
										...
										'</span>',
									'{{/if}}',
									'<input type="text" id="{{id}}" origname="{{origname}}" name="{{name}}" class="form-control" placeholder="{{placeholder}}" value="{{value}}" data-type="{{type}}" {{disabled}} {{readonly}} {{mode}} />',
									'{{#if surfix}}',
										'<span class="input-group-addon">',
											'{{{surfix}}}',
										'</span>',
								...
								'</div>',
							'{{else}}',
								'<input type="text" id="{{id}}" origname="{{origname}}" name="{{name}}" class="form-control {{hidden}}" placeholder="{{placeholder}}" value="{{value}}" data-type="{{type}}" {{disabled}} {{readonly}} {{mode}}/>',
							'{{/isInputGroup}}',
							'{{#if help}}',
						...
						'<div class="{{clz}}">',
							'{{#each options}}',
								'<label class="radio-inline {{clz}}">',
									'<input type="radio" origname="{{origname}}" {{disabled}} name="{{name}}" {{disabled}} id="{{id}}" value="{{value}}" {{checked}} />',
									'{{label}}',
								'</label>',
							'{{/each}}',
						'</div>',
						...
						'<div class="{{clz}}">',
							'{{#each options}}',
								'<label class="checkbox-inline {{clz}}">',
									'<input type="checkbox" origname="{{origname}}" name="{{name}}" {{disabled}} id="{{id}}" value="{{value}}" {{checked}} />',
									'{{label}}',
								'</label>',
							'{{/each}}',
						'</div>',
				...
				'{{#checkFormElementType type type="combo"}}',
					'<div class="form-group {{hidden}}">',
						'<label for="{{id}}" class="{{labelClz}}">{{{label}}}</label>',
						'<div class="{{clz}}">',
							'<select id="{{id}}" origname="{{origname}}" name="{{name}}" class="form-control" {{disabled}}  data-type="{{type}}">',
								'{{#each options}}',
									'<option value="{{value}}" {{selected}}>{{label}}</option>',
								'{{/each}}',
							'</select>',
							'{{#if help}}',
								'<span class="help-block {{hiddenHelp}}">{{{help}}}</span>',
							'{{/if}}',
						'</div>',
					'</div>',
				'{{/checkFormElementType}}',
				'{{#checkFormElementType type type="hidden"}}',
					'<input type="hidden" id="{{id}}" origname="{{origname}}" name="{{name}}" value="{{value}}" />',
				'{{/checkFormElementType}}',
				'{{#checkFormElementType type type="section"}}',
					'<div class="form-group section">',
						'<label for="{{id}}" class="{{labelClz}}">{{label}}</label>',
							...
							'<div class="min-input {{clz}}">',
								'<div class="input-group">',
									'{{#if prefix}}',
										...
										'</span>',
									'{{/if}}',
									'<input type="text" id="{{id}}" origname="{{origname}}" name="{{name}}" class="form-control" placeholder="{{placeholder}}" value="{{value}}" {{readonly}}  data-type="{{type}}">',
									'{{#if surfix}}',
										'<span class="input-group-addon">',
											'{{{surfix}}}',
										'</span>',
				...
				'{{#checkFormElementType type type="pickgift"}}',
					'<div class="form-group {{hidden}}">',
						...
						'<div class="{{clz}}">',
							'<div class="input-group">',
								'<input type="text" readonly id="{{id}}" origname="{{origname}}" name="{{name}}" value="{{value}}" class="form-control" />',
								'<span class="input-group-btn">',
				...
				'{{#checkFormElementType type type="switcher"}}',
					'<div class="form-group">',
						'<label for="{{id}}" class="{{labelClz}}">{{label}}</label>',
						'<div class="{{clz}}">',
							'<input type="checkbox" id="{{id}}" origname="{{origname}}" name="{{name}}" value="{{defaultVal}}" data-type="{{type}}" data-onLabel="{{onLabel}}" data-offLabel="{{offLabel}}" {{checked}} />',
						'</div>',
					'</div>',
				'{{/checkFormElementType}}',
			'{{/each}}',
	...
	TplLib.register('tpl_promotion_levelset', tpl_promotion_levelset);

	var tpl_promotion_TimeCheck = [
	'<div class="promotion_TimeCheck">',
		'<div class="oldPromotion">',
			'<h4>原促销规则</h4>',
			'{{#each option.oldPromotionDs}}',
				'<p><del>{{startDate}}至{{endDate}}&nbsp;业务类型：{{supportOrderType}}&nbsp;节假日：{{holidayFlag}}&nbsp;{{timeID}}时段&nbsp;{{rules}}</del></p>',
			'{{/each}}',
		'</div>',
		'<div class="newPromotion">',
			'<h4>现促销规则</h4>',
			'{{#each option.newPromotionDs}}',
				'<p>{{startDate}}至{{endDate}}&nbsp;业务类型：{{supportOrderType}}&nbsp;节假日：{{holidayFlag}}&nbsp;{{timeID}}时段&nbsp;{{rules}}</p>',
			'{{/each}}',
		'</div>',
	'</div>'
    ].join('');
    Hualala.TplLib.register('tpl_promotion_TimeCheck', tpl_promotion_TimeCheck);

    var tpl_promotion_preview = [
		'<div class="clearfix">',
				...
				'<div class="media">',
					'<div class="media-body">',
						'<div class="form-horizontal">',
							'<div class="form-group">',
								'<label class="{{infoLabelClz}} control-label">促销日期:</label>',
								'<div class="col-sm-9">',
									'<p class="form-control-static">{{startDate}}到{{endDate}}</p>',
								'</div>',
							'</div>',
						'</div>',
						'<div class="form-horizontal">',
							'<div class="form-group">',
								'<label class="{{infoLabelClz}} control-label">适用业务类型:</label>',
								'<div class="col-sm-9">',
									'<p class="form-control-static">{{{supportOrderType}}}</p>',
								'</div>',
							'</div>',
						'</div>',
						'<div class="form-horizontal">',
							'<div class="form-group">',
								'<label class="{{infoLabelClz}} control-label">节假日限制:</label>',
								'<div class="col-sm-9">',
									'<p class="form-control-static">{{{holidayFlag}}}</p>',
								'</div>',
							'</div>',
						'</div>',
						'<div class="form-horizontal">',
							'<div class="form-group">',
								'<label class="{{infoLabelClz}} control-label">时段限制:</label>',
								'<div class="col-sm-9">',
									'<p class="form-control-static">{{{timeID}}}</p>',
								'</div>',
							'</div>',
						'</div>',
						'<div class="form-horizontal">',
							'<div class="form-group">',
								'<label class="{{infoLabelClz}} control-label">促销信息:</label>',
								'<div class="col-sm-9">',
									'<p class="form-control-static">{{{promotionDesc}}}</p>',
								'</div>',
							'</div>',
						'</div>',
					'</div>',
    ...
    Hualala.TplLib.register('tpl_promotion_preview', tpl_promotion_preview);
