(function ($, window) {
    ...
    '<div id="shopCreateWizard">',
        ...
        '<div class="tab-content">',
            '<!-- 第一步 -->',
            '<form class="row tab-pane" id="tab1">',
                '<div class="col-sm-6 col-md-4 form-horizontal">',
                    ...
                    '</div>',
                    '<div class="form-group">',
                        '<label class="col-sm-3 control-label" for="PCC">* 人均消费</label>',
                        '<div class="col-sm-8">',
                            '<input type="text" id="PCC" name="PCC" class="form-control" />',
                        '</div>',
                    '</div>',
                '</div>',
                '<div class="col-sm-6 col-md-4 form-horizontal">',
                    ...
                    '<div class="form-group">',
                        ...
                        '<div class="col-xs-4">',
                            '<input type="text" id="openingHoursStart" name="openingHoursStart" class="form-control"  placeholder="08:30" data-default-time="08:30" />',
                        '</div>',
                        '<div class="col-xs-4">',
                            '<input type="text" id="openingHoursEnd" name="openingHoursEnd" class="form-control"  placeholder="21:30" data-default-time="21:30" />',
                        '</div>',
                    '</div>',
                    '<div class="form-group">',
                ...
                '<div id="uploadImg" class="col-sm-6 col-md-4">',
                    ...
                    '<img class="m-t" src="/src/img/shop_head_img_default.png" alt="餐厅门头图" width="200" height="200" />',
                '</div>',
                '<input id="keywordLst" name="keywordLst" type="hidden" value="" />',
            '</form>',
            '<!-- 第二步 -->',
                ...
                '<div class="map-search row">',
                    '<div class="col-sm-4">',
                        '<div class="input-group">',
                            '<input id="keywordmap" class="form-control" type="text" placeholder="搜索地图" />',
            ...
            '<div class="tab-pane t-c" id="tab3">',
                '<div class="d-ib t-l">',
                    ...
                    '<ul>',
                        ...
                        '</li>',
                        '<li>',
                            '<a class="btn btn-success" href="">设置店铺功能</a>',
                        '</li>',
                        '<li>网上餐厅正式开通啦！</li>',
                    '</ul>',
                '</div>',
