(function ($, window) {
		...
		'<div class="tab-content">',
			...
			'<div class="tab-pane map-wrap" id="tab2">',
				'<div class="map-search row">',
					'<div class="col-sm-4">',
						'<div class="input-group map-search-box">',
							'<input class="form-control map-keyword" type="text" placeholder="搜索地图" />',
							'<span class="input-group-addon glyphicon glyphicon-search map-search-btn"></span>',
						'</div>',
					'</div>',
    ...
    '<form class="row shop-info feed-back-out read-mode">',
        ...
        '<div id="uploadImg" class="col-sm-6 col-lg-3 t-r">',
            '<img src="/src/img/shop_head_img_default.png" alt="餐厅门头图" width="200" height="200" />',
        '</div>',
        '<div class="col-sm-6 col-lg-3">',
            '<div class="map_canvas" id="mapCanvas">地图容器</div>',
            '<div class="map-result">当前经纬度</div>',
        '</div>',
        '<div class="step-action">',
