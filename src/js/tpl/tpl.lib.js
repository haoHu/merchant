		...
		'<div class="jumbotron login-box">',
			'<div class="row">',
				...
				'<div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">',
							...
							'<div class="form-horizontal">',
								...
								'<div class="form-group">',
									'<div class="col-md-offset-1 col-md-10">',
										'<input id="group_name" name="group_name" type="text" placeholder="请输入集团主账号" class="form-control input-md" tabIndex="1">',
									'</div>',
								'</div>',
								'<!-- Text input-->',
								'<div class="form-group">',
									'<div class="col-md-offset-1 col-md-10">',
										'<input id="group_subname" name="group_subname" type="text" placeholder="请输入集团子账号" class="form-control input-md" tabIndex="2" >',
									'</div>',
								'</div>',
								'<!-- Password input-->',
								'<div class="form-group">',
								...
								'<div class="form-group">',
									'<div class="col-md-offset-1 col-md-10">',
										'<button type="submit" id="login_sub" name="login_sub" class="btn btn-warning btn-lg form-control " tabIndex="5">登录</button>',
								...
								// '<div class="form-group">',
								// 	'<div class="col-md-offset-1 col-md-10">',
								// 		'<a class="btn btn-link pull-right" href="javascript:void(0);">忘记密码？</a>',
								// 	'</div>',
								// '</div>',
							'</div>',
						'</div>',
					...
					// 	'<div class="panel-heading">',
					// 		'<h3 class="panel-title">忘记密码登录</h3>',
					// 	'</div>',
					// 	'<div class="panel-body">',
					// 		'<div class="form-horizontal">',
					// 			'<!-- Text input-->',
					...
					// 			'<div class="form-group">',
					// 				'<div class="col-md-offset-1 col-md-10">',
					// 					'<input id="group_mobile" name="group_mobile" type="text" placeholder="请输入手机号" class="form-control input-md" tabIndex="2" >',
					// 				'</div>',
					// 			'</div>',
					// 			'<!-- Text input-->',
					// 			'<div class="form-group">',
					// 				'<div class="col-md-offset-1 col-xs-7 col-md-6 col-lg-6">',
					// 					'<input id="group_pwd" name="group_pwd" type="password" placeholder="请输入短信动态密码" class="form-control input-md" tabIndex="2" >',
					// 				'</div>',
					// 				'<div class="col-xs-4 col-md-3 col-lg-3">',
					// 					'<button class="btn btn-warning form-control">获取密码</button>',
					// 				'</div>',
					// 			'</div>',
					// 			'<!-- Button -->',
					// 			'<div class="form-group">',
					// 				'<div class="col-md-offset-1 col-md-10">',
					// 					'<button type="submit" id="login_mobile" name="login_mobile" class="btn btn-warning btn-lg form-control " tabIndex="5">登录</button>',
					// 					'<div class="progress hidden">',
					// 						'<div class="progress-bar progress-bar-warning progress-bar-striped active"  role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%">',
					// 							// '<span class="sr-only">45% Complete</span>',
					// 						'</div>',
