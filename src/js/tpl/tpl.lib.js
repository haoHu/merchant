					...
					'<div class="panel panel-warning panel-login">',
						...
						'<div class="panel-body">',
							...
							'<div class="form-horizontal">',
								...
								'<div class="form-group">',
									'<div class="col-md-offset-1 col-md-10">',
										'<a class="btn btn-link pull-right btn-change-mode" data-mode="mobile" href="javascript:void(0);">忘记密码？</a>',
									'</div>',
								'</div>',
							'</div>',
						'</div>',
							...
							'<div class="form-horizontal">',
								...
								'<div class="form-group">',
									'<div class="col-md-offset-1 col-xs-7 col-md-6 col-lg-6">',
										'<input id="mobile_pwd" name="mobile_pwd" type="password" placeholder="请输入短信动态密码" class="form-control input-md" tabIndex="2" >',
									'</div>',
