(function ($, window) {
	 ...
	 * @type {Array}
	 */
	Hualala.Shop.PromotionWizardCfg = [
		{id : "promotion_way", label : "设置促销方式"},
		{id : "promotion_content", label : "设置促销内容"},
		{id : "promotion_time", label : "设置促销时间"},
		{id : "promotion_on", label : "预览并启用"}
	];
	/**
	 * 向导步骤按钮设置
	 * @type {Array}
	 */
	Hualala.Shop.WizardCtrls = [
	...
	var PromotionWizardModal = Stapes.subclass({
		/**
		 * 构造向导
	...
	Hualala.Shop.PromotionWizardModal = PromotionWizardModal;
