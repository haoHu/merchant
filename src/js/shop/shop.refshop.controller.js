(function ($, window) {
	...
	var QueryPromotionShopController = Stapes.subclass({
		/**
		 * 店铺查询控制器
	...
	QueryPromotionShopController.proto({
		// 初始化控制器
		init : function () {
			var self = this;
			self.bindEvent();
	...
	Hualala.Shop.QueryPromotionShopController = QueryPromotionShopController;
})(jQuery, window);